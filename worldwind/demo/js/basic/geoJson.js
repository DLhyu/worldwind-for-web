    ...
    function (WorldWind, wwd) {
        ...
        return {
            show: function () {
                ...
                // Feature Collection
                var chinaLayer = new WorldWind.RenderableLayer("Feature Collection - China");
                var chinaGeoJSON = new WorldWind.GeoJSONParser(localJson);
                chinaGeoJSON.load(null, shapeConfigurationCallback, chinaLayer);
                wwd.addLayer(chinaLayer);
            }
        }
    });