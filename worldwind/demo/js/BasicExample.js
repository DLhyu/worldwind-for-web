...
define(['./WorldWindShim',
    ...
    function (WorldWind,
        ...
        // Web Map Tiling Service information from
        // var serviceAddress = "http://{s}.tianditu.com/img_w/wmts?service=WMTS&version=1.0.0&request=GetTile&tilematrix={TileMatrix}&layer=img&style={style}&tilerow={TileRow}&tilecol={TileCol}&tilematrixset={TileMatrixSet}&format=tiles&tk=fb0dd2b4158b2f9d4bec0aaaf9722801";
        // // Layer displaying Global Hillshade based on GMTED2010
        ...
        //
        // var restLayer = WorldWind.RestTiledImageLayer(url);
        // wwd.addLayer(restLayer);
